...
namespace DingKit
{
    ...
    public class COdbc
    {
        ...
        //CConfig.GetValueByKey("OdbcConnString");
        ...
        public static DataSet CreateDataSet(String strSQL)
        {
            ...
            try
            {
                OdbcDataAdapter objCmd = new OdbcDataAdapter(strSQL, ConnString);
                objCmd.Fill(ds);
                objCmd.Dispose();
            }
            catch (Exception e)
        ...
        public static OdbcDataReader CreateReader(string strsql)
        {
            OdbcDataReader da;
            OdbcConnection OdbcConn = new OdbcConnection(ConnString);
            try
            {
                OdbcCommand cmdTable = new OdbcCommand(strsql, OdbcConn);
        ...
        public static string GetStringSingle(String strSQL)
        {
            ...
            try
            {
                ...
                OdbcDataReader reader = command.ExecuteReader(CommandBehavior.SingleRow);
        ...
        public static string Dlookup(string table, string field, string sWhere)
        {
            ...
            OdbcConnection Connection = new OdbcConnection(ConnString);
            Connection.Open();
            OdbcCommand command = new OdbcCommand(sSQL, Connection);
            OdbcDataReader reader = command.ExecuteReader(CommandBehavior.SingleRow);
            string sReturn;
